    ...
    <div class="flex min-h-screen items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8 bg-cyan-300 p-5 z-10">
            <a-form :model="loginState" @finish="handleFinish" @finishFailed="handleFinishFailed">
                <a-form-item :label="t('setmsg.login.emailText')" name="email"
                    :rules="[{ required: true, message: `${t('setmsg.formRulesMsg.emailMsgText')}` }]">
                ...
                <a-form-item :label="t('setmsg.login.passwordText')" name="pwd"
                    :rules="[{ required: true, message: `${t('setmsg.formRulesMsg.passwordMsgText')}` }]">
                ...
                <a-form-item :label="t('setmsg.login.selectAccountText')" name="user"
                    :rules="[{ require: true, message: `${t('setmsg.formRulesMsg.accountMsgText')}` }]">
        ...
        <div>
            <a-modal v-model:visible="visible" title="人机验证" :closable="false" :footer="null">
