        ...
        >
          <a-row :gutter="20">
            <a-col :span="8">
              <a-form-item
                name="userName"
                :label="t('setmsg.appointForm.nameText')"
              >
                <a-input
            ...
            <a-col :span="8">
              <a-form-item
                :label="t('setmsg.appointForm.phoneText')"
                name="telephone"
              >
                <a-input
                  :min="0"
            ...
            <a-col :span="8">
              <a-form-item
                :label="t('setmsg.appointForm.dateText')"
                name="date"
              >
                <a-date-picker
            ...
            <a-col :span="8">
              <a-form-item
                :label="t('setmsg.appointForm.timeText')"
                name="time"
              >
                <a-time-picker
            ...
            <a-col :span="8">
              <a-form-item
                :label="t('setmsg.appointForm.selectAppointDepartmentText')"
                name="fail"
              >
                <a-select
            ...
            <a-col :span="8">
              <a-form-item
                :label="t('setmsg.appointForm.selectAppointDoctorText')"
                name="doctor"
              >
                <a-select
                  v-model:value="formState.doctor"
                  show-search
                  placeholder="Dr.Peterson"
                  :options="options"
                  :filter-option="filterOption"
                ></a-select>
              </a-form-item>
